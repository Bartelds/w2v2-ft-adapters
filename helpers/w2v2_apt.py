...
from .custom_wav2vec2 import Wav2Vec2ForCTC as custom_Wav2Vec2ForCTC

def configure_hf_w2v2_model(config, w2v2_config={}):
    ...
    model = custom_Wav2Vec2ForCTC.from_pretrained(
